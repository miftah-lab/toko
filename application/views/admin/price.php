...
<html>
   ...
   <title>Admin</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/jeasyui/themes/icon.css'); ?>">
        ...
        <script type="text/javascript">
        	const BASE_URL = "<?php echo base_url("price")?>";
        </script>
   </head>
   ...
   <body>
    ...
    <div class="container mt-4">
      ...
      <!-- Toolbar -->
      <div id="toolbar">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newPrice()">Tambah</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editPrice()">Edit</a>
      ...
      <div id="dlg" class="easyui-dialog">
        <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
          <div style="margin-bottom:10px">
              <input name="isbn" id="isbn" class="easyui-combobox" required="true" label="ISBN" style="width:100%">
          </div>
          <div style="margin-bottom:10px">
    ...
    <script src="<?= base_url('assets/js/price.js'); ?>"></script>
   </body>
</html>